...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        View view = LayoutInflater
                .from(context)
                .inflate(R.layout.pull_loadmore_layout, null);
    ...
    public boolean getSwipeRefreshEnable() {
        return mPullToRefreshView.isEnabled();
    }


    public PullToRefreshView getSwipeRefreshLayout() {
        ...
        mPullToRefreshView.post(new Runnable() {
            ...
            public void run() {
                if (pullRefreshEnable)
                    mPullToRefreshView.setRefreshing(isRefreshing);
            }
        });
    }
